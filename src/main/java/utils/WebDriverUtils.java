...
public class WebDriverUtils {
    ...
    public static final JavascriptExecutor js = (JavascriptExecutor) SingletonDriver.getDriver();
    public static final Actions action = new Actions(SingletonDriver.getDriver());
